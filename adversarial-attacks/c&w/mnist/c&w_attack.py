...
with tf.Graph().as_default():
  with tf.Session() as sess:
    ...
    cnw = CarliniWagnerL2(wrap, sess=sess)
    params = {'binary_search_steps': 1,
              ...
              'initial_const': 10}
    #"""
    x_adv_1 = cnw.generate_np(adv_inputs[:10], **params)
    x_adv_2 = cnw.generate_np(adv_inputs[10:20], **params)
    x_adv_3 = cnw.generate_np(adv_inputs[20:30], **params)
    x_adv_4 = cnw.generate_np(adv_inputs[30:40], **params)
    x_adv_5 = cnw.generate_np(adv_inputs[40:], **params)
    x_adv = np.concatenate((x_adv_1, x_adv_2, x_adv_3, x_adv_4, x_adv_5), axis=0)
    #"""
    #x_adv = cnw.generate_np(adv_inputs, **params)
