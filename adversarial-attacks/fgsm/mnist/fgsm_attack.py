...
with tf.Graph().as_default():
  with tf.Session() as sess:
    ...
    fgsm_params = {'eps': 0.3,
                 'clip_min': 0.,
                 'clip_max': 1.}
    x_adv_1 = fgsm.generate_np(adv_inputs[:10], **fgsm_params)
    x_adv_2 = fgsm.generate_np(adv_inputs[10:20], **fgsm_params)
    x_adv_3 = fgsm.generate_np(adv_inputs[20:30], **fgsm_params)
    x_adv_4 = fgsm.generate_np(adv_inputs[30:40], **fgsm_params)
    x_adv_5 = fgsm.generate_np(adv_inputs[40:], **fgsm_params)
